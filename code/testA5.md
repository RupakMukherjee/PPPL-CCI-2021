...
deep_approx.add(layers.Dense(1000, input_dim=2, activation='elu'))
deep_approx.add(layers.Dense(1000, activation='elu'))
deep_approx.add(layers.Dense(10, activation='linear'))
...
deep_stepper2.add(layers.Dense(15, input_dim=3, activation='elu'))
deep_stepper2.add(layers.Dense(1, activation='elu'))
