...
deep_stepper2.add(layers.Dense(100, input_dim=2, activation='elu'))
deep_stepper2.add(layers.Dense(80, activation='elu'))
...
# Fit!
history = deep_stepper2.fit(Xs_train, ys_train, epochs=50, batch_size=32,
            validation_data=(Xs_dev, ys_dev),
            callbacks=keras.callbacks.EarlyStopping(patience=5))
