...
deep_approx.add(layers.Dense(4, input_dim=2, activation='elu'))
deep_approx.add(layers.Dense(4, activation='elu'))
deep_approx.add(layers.Dense(5, activation='linear'))
